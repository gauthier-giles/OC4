...
public class DBConstants {
    ...
    public static final String VEHICLE_ISNT_ALREADY_GONE = "SELECT VEHICLE_REG_NUMBER, OUT_TIME FROM ticket WHERE VEHICLE_REG_NUMBER=? and OUT_TIME IS NULL"; // and timediff(now(), OUT_TIME)<'00:00:05'";
